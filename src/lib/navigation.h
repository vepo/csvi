...
NavigationResult navigate_page_previous(coordinates_t *top_cell, coordinates_t *cursor_position, const screen_size_t *screen_size);
NavigationResult navigate_page_next(coordinates_t *top_cell, coordinates_t *cursor_position, const screen_size_t *screen_size, size_t num_columns);
